...
public class RuleExtractionTest {
	
	@Before
	public void setUp()
	{		
		aligner = new VamshiNodeAligner(MAX_VIRTUAL_COMPONENTS);
		extractor = new BaseGrammarExtractor(MAX_RULE_SIZE, MAX_RULE_SIZE, true);
		...
		ruleSet.add(new MockExtractedRule("G", "B", "Q", "c [D" + DELIM + "Q,1]", "[D" + DELIM + "Q,1]", "1-0", "OO OO"));
		ruleSet.add(new MockExtractedRule("G", "B", "R", "[B" + DELIM + "Q,1]", "[B" + DELIM + "Q,1] p", "0-0", "OO OO"));
		ruleSet.add(new MockExtractedRule("P", "B", "R", "c d", "q p", "1-0", "OO"));
		ruleSet.add(new MockExtractedRule("G", "B", "R", "c [D" + DELIM + "R,1]", "[D" + DELIM + "R,1]", "1-0", "OO OO"));
		ruleSet.add(new MockExtractedRule("P", "D", "Q", "d", "q", "0-0", "OO"));
		ruleSet.add(new MockExtractedRule("G", "D", "R", "[D" + DELIM + "Q,1]", "[D" + DELIM + "Q,1] p", "0-0", "OO OO"));
		...
		ruleSet.add(new MockExtractedRule("P", "A","Z","d c e","x w y","0-0 0-1 1-2 2-2","OO"));
								 ...
								 String aligns, int index)
	{
		...
		assertTrue("There were " + rules.size() + " rules (" + rules + ") Expected: " + goodRules.size() 
			       + "(" + goodRules + ")", 
				   goodRules.size() == rules.size());
